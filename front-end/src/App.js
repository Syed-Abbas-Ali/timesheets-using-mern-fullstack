    ...
    <div className="App">
      ...
      <Routes>
        ...
        {/* <Route index element={<Nav2/>}/> */}
          ...
          <Route path="adminhome" element={admin && admin._id ?<AdminPro/>:<AdminSignin setadmin={updateadmin}/>} />
          <Route path="Notification" element={admin && admin._id ?<Notifications/>:<AdminSignin setadmin={updateadmin}/>} />
