...
const Notifications = () => {
  ...
  const workoutdarta=async()=>{
    const response=await axios.get("https://inkprog-timesheets.herokuapp.com/api/signinup/singleuser");
...
const updatedetail=async()=>{
  // e.preventDefault();
  console.log(`${id}`)
await axios.patch(`https://inkprog-timesheets.herokuapp.com/api/signinup/hidenotifi/${id}`,display)
// console.log(`${id}`)
...
const leavenotification=async()=>{
  const response=await axios.get("https://inkprog-timesheets.herokuapp.com/api/admin/leavesnotifi");
  const data=response.data
  getleavenotifi(data);
  console.log(notifi)
}
...
const handlesubmit=(e)=>{
    ...
    axios.post(`https://inkprog-timesheets.herokuapp.com/api/admin/payslip/upload/`,formData,headConfig)
    .then(res=>{
        console.log(res);
    })
    .catch(err=>{
